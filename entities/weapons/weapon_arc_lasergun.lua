--Rapid Fire Laser Machine (RaFiLaM)
SWEP.UseHands = true
SWEP.PrintName			= "RaFiLaM (Rapid Fire LASER Machine)"		-- 'Nice' Weapon name (Shown on HUD)	
...
SWEP.Purpose		= "Laser Gun for Laser Wars"
...
function SWEP:PrimaryAttack()
	...
	-- Play shoot sound
	self.Weapon:EmitSound("arc_lasertag/weapons/fire_big.wav")
